...
const i18n = {
  zh: {
    ...
    heroTitle: "我在 UE5 里搭玩法骨架，也给奇怪想法找一条能跑起来的路。",
    heroDescription: "关注战斗、技能、输入、UI 同步和数据驱动流程。比起堆功能，我更在意系统边界清楚、调试路径清楚、以后还能继续加内容。",
    ctaGithub: "GitHub",
    ctaVideo: "Bilibili",
    heroLocation: "China",
  ...
  en: {
    ...
    heroTitle: "I build gameplay skeletons in UE5 and give odd ideas a way to move.",
    heroDescription: "My focus is combat, abilities, input, UI sync, and data-driven workflows. I care less about piling on features and more about clear system boundaries, clear debugging paths, and room for future content.",
    ctaGithub: "GitHub",
    ctaVideo: "Bilibili",
    heroLocation: "China",
    heroFocus: "Gameplay systems",
